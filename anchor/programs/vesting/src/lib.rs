...
declare_id!("6SZBhVbQBDJcZRwTvByR9tD2YiDvdZMbNFWwutGQ31y8");

#[program]
pub mod vesting {
    use super::*;

  // instruction handler for create vesting
  ...
  // employee account instruction handler
  ...
  // instruction handler for claim token
  pub fn claim_tokens(
...
// data structure for create vesting handler
#[derive(Accounts)]
...
// data structure for create employee account
#[derive(Accounts)]
...
// data structure for claim tokens
#[derive(Accounts)]
#[instruction(company_name: String)]
...
//account's structure for vesting account
#[account]
#[derive(InitSpace)]
...
//account's structure for employee account
#[account]
#[derive(InitSpace)]
